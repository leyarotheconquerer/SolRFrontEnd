		...
		return (
			<li className={cx({"list-group-item": bootstrapCss})}>
				...
				<div style={{display: collapse ? "none" : "block"}}>
					<Datetime id="datetime1" defaultValue="*" onChange={this.onStartRangeChange} closeOnSelect={true}/>
					<button className={cx({"btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss})} onClick={this.handleSubmit.bind(this)}>
						<SearchIcon />
					</button>
					<br/>
					<Datetime id="datetime2" defaultValue="NOW" onChange={this.onEndRangeChange} closeOnSelect={true}/>
					<button className={cx({"btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss})} onClick={this.handleSubmit.bind(this)}>
						<SearchIcon />
					</button>
				</div>
